...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal" action="updateR"  method="post" >
			<input type="hidden" name="video_id" value="${video.video_id }">
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">视频标题</label>
				<div class="col-sm-10">
					<input class="form-control" name="title" id="subjectTitle" value="${video.title}" type="text">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="time" id="subjectTitle" value="${video.time}" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">封面图片地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="image_url" id="subjectTitle" value="${video.image_url}" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">视频播放地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="video_url" id="subjectTitle" value="${ video.video_url}" type="text">
				</div>
			</div>
			<div class="form-group">
