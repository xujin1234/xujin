...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		<form id="infoForm" class="form-horizontal" action="updateR2"  method="post" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="speaker_job" id="subjectTitle" value="${speaker.speaker_job}" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">头像地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="pic_url" id="subjectTitle" value="${speaker.pic_url }" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">简介</label>
				<div class="col-sm-10">
					<input class="form-control" name="speaker_desc" id="subjectTitle" value="${speaker.speaker_desc }" type="text">
				</div>
			</div>
			<div class="form-group">
